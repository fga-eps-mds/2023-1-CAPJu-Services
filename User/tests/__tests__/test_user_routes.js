...
describe('UserController', () => {
  ...
  describe('getUserByCpf', () => {
    ...
    it('should return 500 if an error occurs', async () => {
      ...
      userServiceMock.getUserByCpf = jest.fn().mockRejectedValue(new Error(errorMessage));
      reqMock.params.cpf = '1234567890';
      ...
      expect(resMock.json).toHaveBeenCalledWith({ message: 'Erro ao buscar usuário' });
    });
  });
  ...
  describe('getAllUsers', () => {
    ...
    it('should return 500 if an error occurs', async () => {
      const errorMessage = 'Internal server error';
      userServiceMock.getAllUsers = jest.fn().mockRejectedValue(new Error(errorMessage));
  ...
  describe('loginUser', () => {
    it('should authenticate user with valid credentials', async () => {
      ...
      userServiceMock.getUserByCpfWithPassword = jest.fn().mockResolvedValue(user);
      ...
      expect(userServiceMock.getUserByCpfWithPassword).toHaveBeenCalledWith('1234567890');
    ...
    it('should return 401 if user does not exist', async () => {
      userServiceMock.getUserByCpfWithPassword = jest.fn().mockResolvedValue(null);
    ...
    it('should return 500 if an error occurs', async () => {
      const errorMessage = 'Internal server error';
      userServiceMock.getUserByCpfWithPassword = jest.fn().mockRejectedValue(new Error(errorMessage));
  ...
  describe('store', () => {
    ...
    it('should return 500 if an error occurs', async () => {
      const errorMessage = 'Internal server error';
      userServiceMock.createUser = jest.fn().mockRejectedValue(new Error(errorMessage));
