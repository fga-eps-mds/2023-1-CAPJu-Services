...
const routesPermissions = [
    {
        ...
        childRoutes: [
            ...
            { path: '/updateProcess/:idProcess', permissions: 'edit-process', method: 'PUT' },
            { path: '/deleteProcess/:idProcess', permissions: 'delete-process', method: 'DELETE' },
            { path: '/finalizeProcess/:idProcess', permissions: 'end-process', method: 'PUT', },
            { path: '/archiveProcess/:idProcess/:archiveFlag', permissions: 'archive-process', method: 'PUT', },
            { path: '/updateStage', permissions: 'forward-stage', method: 'PUT', },
            { path: '/keys/:idFlow/:record', permissions: 'see-process', method: 'GET', },
        ]
    },
    {
        parentPath: '/flow',
    ...
    },
    {
        ...
        childRoutes: [
            ...
            { path: '/deleteStage/:idStage', permissions: 'delete-stage', method: 'DELETE' },
