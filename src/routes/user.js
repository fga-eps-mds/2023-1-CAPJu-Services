...
UserRoutes.post('/logout/:logoutInitiator', controllers.userController.logoutUser);
UserRoutes.post('/logoutExpiredSession', controllers.userController.logoutExpiredSession);
UserRoutes.patch('/logoutAsAdmin/:sessionId', controllers.userController.logoutAsAdmin);
UserRoutes.get('/sessionStatus/:sessionId', controllers.userController.getSessionStatus);
