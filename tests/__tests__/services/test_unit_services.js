...
describe("UnitService", () => {
  ...
  it("with attributes is empty", async () => {
    const where = {}
    const attributes = {}
    const query = [{ idProcess: 1, nickname: "processo 1", record: '1234567890', priority: 1, idFlow: 1 }]
  ...
  it("with attributes not empty", async () => {
    const where = {}
    const attributes = [
      { idProcess: 1, nickname: "processo 1", record: '1234567890', priority: 1, idFlow: 1 },
      { idProcess: 2, nickname: "processo 2", record: '1234567890', priority: 1, idFlow: 1 }
    ]
